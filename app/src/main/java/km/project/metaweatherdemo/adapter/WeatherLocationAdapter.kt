...
class WeatherLocationAdapter(private val listWeatherData: List<WeatherDataModel>) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        itemHolder.txtCityName.text = listWeatherData[position - 1].location.title
        itemHolder.viewWeatherToday.setWeather(listWeatherData[position - 1].todayWeather)
        itemHolder.viewWeatherTomorrow.setWeather(listWeatherData[position - 1].tomorrowWeather)
    }
